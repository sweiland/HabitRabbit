...
const routes: Routes = [
  ...
  {path: 'habit-form', component: HabitFormComponent, canActivate: [AuthGuard], resolve: {memberOptions: UserResolver, typeOptions: TypeResolver}},
  ...
  {path: 'type-form/:id', component: TypeFormComponent, canActivate: [AuthGuard]},
