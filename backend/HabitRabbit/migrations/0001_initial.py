#  0001_initial.py Copyright (c) 2020 by the HabitRabbit developers (ardianq, lachchri16, sweiland, YellowIcicle).

# Generated by Django 3.0.2 on 2020-01-09 11:10
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('friends', models.ManyToManyField(null=True, related_name='_user_friends_+', to=settings.AUTH_USER_MODEL)),
